...
const EXERCISE_LIBRARY = [
  ...
  {id:"bench_press", name:"Bench Press (Barbell)", muscle:"Chest", video:"gRVjAtPip0Y"},
  {id:"incline_bench_press", name:"Incline Bench Press (Barbell)", muscle:"Chest", video:"kQtx01Qz6s8"},
  ...
  {id:"lateral_raise", name:"Lateral Raise (Dumbbell)", muscle:"Shoulders", video:"b_LEX4n9lOs"},
  ...
  {id:"barbell_row", name:"Bent Over Row (Barbell)", muscle:"Back", video:"ML1L5ytxLMY"},
  {id:"seated_cable_row", name:"Seated Cable Row - Bar Grip", muscle:"Back", video:"xQNrFHEMhI4"},
  ...
  {id:"bicep_curl", name:"Bicep Curl (Dumbbell)", muscle:"Biceps", video:"6DeLZ6cbgWQ"},
  {id:"hammer_curl", name:"Hammer Curl (Dumbbell)", muscle:"Biceps", video:"BRVDS6HVR9Q"},
  ...
  {id:"russian_twist", name:"Russian Twist (Bodyweight)", muscle:"Core", video:"IJDOoVyVjhc"},
  ...
  {id:"e21s_bicep_curl", name:"21s Bicep Curl", muscle:"Biceps"},
  {id:"ab_scissors", name:"Ab Scissors", muscle:"Core"},
  {id:"ab_wheel", name:"Ab Wheel", muscle:"Core"},
  {id:"aerobics", name:"Aerobics", muscle:"Cardio"},
  {id:"air_bike", name:"Air Bike", muscle:"Cardio"},
  {id:"arnold_press_dumbbell", name:"Arnold Press (Dumbbell)", muscle:"Shoulders"},
  {id:"around_the_world", name:"Around The World", muscle:"Chest"},
  {id:"assisted_pistol_squats", name:"Assisted Pistol Squats", muscle:"Quadriceps"},
  ...
  {id:"back_extension_weighted_hyperextension", name:"Back Extension (Weighted Hyperextension)", muscle:"Back"},
  {id:"ball_slams", name:"Ball Slams", muscle:"Full Body"},
  {id:"band_pullaparts", name:"Band Pullaparts", muscle:"Upper Back"},
  {id:"battle_ropes", name:"Battle Ropes", muscle:"Full Body"},
  {id:"behind_the_back_bicep_wrist_curl_barbell", name:"Behind the Back Bicep Wrist Curl (Barbell)", muscle:"Forearms"},
  {id:"behind_the_back_curl_cable", name:"Behind the Back Curl (Cable)", muscle:"Biceps"},
  {id:"belt_squat_machine", name:"Belt Squat (Machine)", muscle:"Quadriceps"},
  {id:"bench_dip", name:"Bench Dip", muscle:"Triceps"},
  {id:"bench_press_close_grip_barbell", name:"Bench Press - Close Grip (Barbell)", muscle:"Triceps"},
  {id:"bench_press_wide_grip_barbell", name:"Bench Press - Wide Grip (Barbell)", muscle:"Chest"},
  {id:"bench_press_cable", name:"Bench Press (Cable)", muscle:"Chest"},
  {id:"bench_press_dumbbell", name:"Bench Press (Dumbbell)", muscle:"Chest"},
  {id:"bench_press_smith_machine", name:"Bench Press (Smith Machine)", muscle:"Chest"},
  {id:"bent_over_row_band", name:"Bent Over Row (Band)", muscle:"Back"},
  {id:"bent_over_row_dumbbell", name:"Bent Over Row (Dumbbell)", muscle:"Back"},
  {id:"bicep_curl_barbell", name:"Bicep Curl (Barbell)", muscle:"Biceps"},
  {id:"bicep_curl_cable", name:"Bicep Curl (Cable)", muscle:"Biceps"},
  {id:"bicep_curl_machine", name:"Bicep Curl (Machine)", muscle:"Biceps"},
  {id:"bicycle_crunch", name:"Bicycle Crunch", muscle:"Core"},
  {id:"bicycle_crunch_raised_legs", name:"Bicycle Crunch Raised Legs", muscle:"Core"},
  {id:"bird_dog", name:"Bird Dog", muscle:"Core"},
  {id:"box_squat_barbell", name:"Box Squat (Barbell)", muscle:"Quadriceps"},
  {id:"boxing", name:"Boxing", muscle:"Cardio"},
  {id:"burpee_broad_jumps", name:"Burpee Broad Jumps", muscle:"Full Body"},
  ...
  {id:"cable_crunch", name:"Cable Crunch", muscle:"Core"},
  {id:"cable_fly_crossovers", name:"Cable Fly Crossovers", muscle:"Chest"},
  {id:"cable_pull_through", name:"Cable Pull Through", muscle:"Glutes"},
  {id:"cable_twist_down_to_up", name:"Cable Twist (Down to up)", muscle:"Core"},
  {id:"cable_twist_up_to_down", name:"Cable Twist (Up to down)", muscle:"Core"},
  {id:"calf_extension_machine", name:"Calf Extension (Machine)", muscle:"Calves"},
  {id:"calf_press_machine", name:"Calf Press (Machine)", muscle:"Calves"},
  ...
  {id:"chest_fly_machine", name:"Chest Fly (Machine)", muscle:"Chest"},
  {id:"chest_fly_suspension", name:"Chest Fly (Suspension)", muscle:"Chest"},
  {id:"chest_press_band", name:"Chest Press (Band)", muscle:"Chest"},
  {id:"chest_press_machine", name:"Chest Press (Machine)", muscle:"Chest"},
  {id:"chest_supported_incline_row_dumbbell", name:"Chest Supported Incline Row (Dumbbell)", muscle:"Back"},
  {id:"chest_supported_reverse_fly_dumbbell", name:"Chest Supported Reverse Fly (Dumbbell)", muscle:"Shoulders"},
  ...
  {id:"clean_pull", name:"Clean Pull", muscle:"Full Body"},
  {id:"climbing", name:"Climbing", muscle:"Full Body"},
  {id:"concentration_curl", name:"Concentration Curl", muscle:"Biceps"},
  {id:"cross_body_hammer_curl", name:"Cross Body Hammer Curl", muscle:"Biceps"},
  {id:"crunch", name:"Crunch", muscle:"Core"},
  {id:"crunch_machine", name:"Crunch (Machine)", muscle:"Core"},
  {id:"crunch_weighted", name:"Crunch (Weighted)", muscle:"Core"},
  {id:"curtsy_lunge_dumbbell", name:"Curtsy Lunge (Dumbbell)", muscle:"Glutes"},
  ...
  {id:"decline_chest_fly_dumbbell", name:"Decline Chest Fly (Dumbbell)", muscle:"Chest"},
  {id:"decline_crunch_weighted", name:"Decline Crunch (Weighted)", muscle:"Core"},
  {id:"decline_push_up", name:"Decline Push Up", muscle:"Chest"},
  {id:"diamond_push_up", name:"Diamond Push Up", muscle:"Triceps"},
  {id:"downward_dog", name:"Downward Dog", muscle:"Full Body"},
  ...
  {id:"floor_press_barbell", name:"Floor Press (Barbell)", muscle:"Chest"},
  {id:"floor_triceps_dip", name:"Floor Triceps Dip", muscle:"Triceps"},
  {id:"flutter_kicks", name:"Flutter Kicks", muscle:"Core"},
  {id:"frog_jumps", name:"Frog Jumps", muscle:"Legs"},
  {id:"frog_pumps_dumbbell", name:"Frog Pumps (Dumbbell)", muscle:"Glutes"},
  {id:"front_lever_hold", name:"Front Lever Hold", muscle:"Back"},
  {id:"front_lever_raise", name:"Front Lever Raise", muscle:"Back"},
  ...
  {id:"good_morning_barbell", name:"Good Morning (Barbell)", muscle:"Hamstrings"},
  {id:"hack_squat", name:"Hack Squat", muscle:"Quadriceps"},
  {id:"hack_squat_machine", name:"Hack Squat (Machine)", muscle:"Quadriceps"},
  {id:"hammer_curl_band", name:"Hammer Curl (Band)", muscle:"Biceps"},
  {id:"hammer_curl_cable", name:"Hammer Curl (Cable)", muscle:"Biceps"},
  {id:"handstand_hold", name:"Handstand Hold", muscle:"Shoulders"},
  ...
  {id:"hip_adduction_machine", name:"Hip Adduction (Machine)", muscle:"Glutes"},
  {id:"hip_thrust_barbell", name:"Hip Thrust (Barbell)", muscle:"Glutes"},
  {id:"hip_thrust_machine", name:"Hip Thrust (Machine)", muscle:"Glutes"},
  {id:"hip_thrust_smith_machine", name:"Hip Thrust (Smith Machine)", muscle:"Glutes"},
  {id:"hollow_rock", name:"Hollow Rock", muscle:"Core"},
  {id:"incline_bench_press_dumbbell", name:"Incline Bench Press (Dumbbell)", muscle:"Chest"},
  ...
  {id:"jumping_lunge", name:"Jumping Lunge", muscle:"Quadriceps"},
  {id:"kettlebell_around_the_world", name:"Kettlebell Around the World", muscle:"Shoulders"},
  {id:"kettlebell_clean", name:"Kettlebell Clean", muscle:"Full Body"},
  {id:"kettlebell_curl", name:"Kettlebell Curl", muscle:"Biceps"},
  {id:"kettlebell_high_pull", name:"Kettlebell High Pull", muscle:"Full Body"},
  {id:"kettlebell_shoulder_press", name:"Kettlebell Shoulder Press", muscle:"Shoulders"},
  ...
  {id:"lateral_leg_raises", name:"Lateral Leg Raises", muscle:"Glutes"},
  {id:"lateral_lunge", name:"Lateral Lunge", muscle:"Quadriceps"},
  {id:"lateral_raise_band", name:"Lateral Raise (Band)", muscle:"Shoulders"},
  {id:"lateral_raise_cable", name:"Lateral Raise (Cable)", muscle:"Shoulders"},
  {id:"lateral_raise_machine", name:"Lateral Raise (Machine)", muscle:"Shoulders"},
  {id:"lateral_squat", name:"Lateral Squat", muscle:"Quadriceps"},
  {id:"leg_extension_machine", name:"Leg Extension (Machine)", muscle:"Quadriceps"},
  ...
  {id:"meadows_rows_barbell", name:"Meadows Rows (Barbell)", muscle:"Back"},
  {id:"muscle_up", name:"Muscle Up", muscle:"Back"},
  {id:"negative_pull_up", name:"Negative Pull Up", muscle:"Back"},
  {id:"nordic_hamstrings_curls", name:"Nordic Hamstrings Curls", muscle:"Hamstrings"},
  {id:"oblique_crunch", name:"Oblique Crunch", muscle:"Core"},
  {id:"one_arm_push_up", name:"One Arm Push Up", muscle:"Chest"},
  {id:"overhead_curl_cable", name:"Overhead Curl (Cable)", muscle:"Biceps"},
  ...
  {id:"pause_squat_barbell", name:"Pause Squat (Barbell)", muscle:"Quadriceps"},
  {id:"pendlay_row_barbell", name:"Pendlay Row (Barbell)", muscle:"Back"},
  {id:"pendulum_squat_machine", name:"Pendulum Squat (Machine)", muscle:"Quadriceps"},
  {id:"pike_pushup", name:"Pike Pushup", muscle:"Shoulders"},
  {id:"pilates", name:"Pilates", muscle:"Core"},
  {id:"pinwheel_curl_dumbbell", name:"Pinwheel Curl (Dumbbell)", muscle:"Biceps"},
  {id:"pistol_squat", name:"Pistol Squat", muscle:"Quadriceps"},
  ...
  {id:"push_press", name:"Push Press", muscle:"Shoulders"},
  {id:"push_up_close_grip", name:"Push Up - Close Grip", muscle:"Triceps"},
  {id:"push_up_weighted", name:"Push Up (Weighted)", muscle:"Chest"},
  {id:"rack_pull", name:"Rack Pull", muscle:"Back"},
  {id:"rear_delt_reverse_fly_cable", name:"Rear Delt Reverse Fly (Cable)", muscle:"Shoulders"},
  {id:"rear_delt_reverse_fly_dumbbell", name:"Rear Delt Reverse Fly (Dumbbell)", muscle:"Shoulders"},
  ...
  {id:"reverse_curl_dumbbell", name:"Reverse Curl (Dumbbell)", muscle:"Biceps"},
  {id:"reverse_fly_single_arm_cable", name:"Reverse Fly Single Arm (Cable)", muscle:"Shoulders"},
  {id:"reverse_grip_concentration_curl", name:"Reverse Grip Concentration Curl", muscle:"Biceps"},
  {id:"reverse_grip_lat_pulldown_cable", name:"Reverse Grip Lat Pulldown (Cable)", muscle:"Back"},
  {id:"reverse_hyperextension", name:"Reverse Hyperextension", muscle:"Back"},
  {id:"reverse_lunge", name:"Reverse Lunge", muscle:"Quadriceps"},
  {id:"reverse_lunge_barbell", name:"Reverse Lunge (Barbell)", muscle:"Quadriceps"},
  {id:"reverse_lunge_dumbbell", name:"Reverse Lunge (Dumbbell)", muscle:"Quadriceps"},
  ...
  {id:"russian_twist_weighted", name:"Russian Twist (Weighted)", muscle:"Core"},
  {id:"scapular_pull_ups", name:"Scapular Pull Ups", muscle:"Back"},
  {id:"seated_cable_row_bar_wide_grip", name:"Seated Cable Row - Bar Wide Grip", muscle:"Back"},
  {id:"seated_cable_row_v_grip_cable", name:"Seated Cable Row - V Grip (Cable)", muscle:"Back"},
  {id:"seated_calf_raise", name:"Seated Calf Raise", muscle:"Calves"},
  {id:"seated_chest_flys_cable", name:"Seated Chest Flys (Cable)", muscle:"Chest"},
  ...
  {id:"side_bend", name:"Side Bend", muscle:"Core"},
  {id:"side_bend_dumbbell", name:"Side Bend (Dumbbell)", muscle:"Core"},
  {id:"single_arm_cable_crossover", name:"Single Arm Cable Crossover", muscle:"Chest"},
  {id:"single_arm_cable_row", name:"Single Arm Cable Row", muscle:"Back"},
  {id:"single_arm_curl_cable", name:"Single Arm Curl (Cable)", muscle:"Biceps"},
  {id:"single_arm_landmine_press_barbell", name:"Single Arm Landmine Press (Barbell)", muscle:"Shoulders"},
  ...
  {id:"single_leg_standing_calf_raise_machine", name:"Single Leg Standing Calf Raise (Machine)", muscle:"Calves"},
  {id:"sissy_squat_weighted", name:"Sissy Squat (Weighted)", muscle:"Quadriceps"},
  {id:"sit_up", name:"Sit Up", muscle:"Core"},
  {id:"sit_up_weighted", name:"Sit Up (Weighted)", muscle:"Core"},
  {id:"skating", name:"Skating", muscle:"Cardio"},
  {id:"ski_erg", name:"Ski Erg", muscle:"Cardio"},
  {id:"skiing", name:"Skiing", muscle:"Cardio"},
  {id:"skullcrusher_barbell", name:"Skullcrusher (Barbell)", muscle:"Triceps"},
  ...
  {id:"standing_calf_raise_dumbbell", name:"Standing Calf Raise (Dumbbell)", muscle:"Calves"},
  {id:"standing_calf_raise_machine", name:"Standing Calf Raise (Machine)", muscle:"Calves"},
  {id:"standing_calf_raise_smith", name:"Standing Calf Raise (Smith)", muscle:"Calves"},
  {id:"standing_leg_curls", name:"Standing Leg Curls", muscle:"Hamstrings"},
  {id:"standing_military_press_barbell", name:"Standing Military Press (Barbell)", muscle:"Shoulders"},
  {id:"step_up", name:"Step Up", muscle:"Quadriceps"},
  {id:"sternum_pull_up_gironda", name:"Sternum Pull up (Gironda)", muscle:"Back"},
  ...
  {id:"walking_lunge", name:"Walking Lunge", muscle:"Quadriceps"},
